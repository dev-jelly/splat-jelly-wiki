...
case $PROVIDER in
    1)
        ...
        echo "2. Select 'octol.ing' domain"
    ...
    2)
        ...
        echo "3. Click 'Domain List' → 'Manage' next to octol.ing"
    ...
    5)
        ...
        echo "2. Navigate to DNS management for 'octol.ing'"
        ...
        echo "Check: https://www.whois.com/whois/octol.ing"
        echo ""
        ;;
    *)
        echo ""
